...
<html>
<head>
  <title>Login Qords Compare</title>
  <meta charset="utf-8">
...
<div class="container">
  ...
  <script src="{{ URL::asset('assets/admin-lte/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ URL::asset('assets/admin-lte/dist/js/adminlte.min.js') }}"></script>
